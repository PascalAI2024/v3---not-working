  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <div className="hidden md:flex space-x-8 ml-12">
                ...
                <a href="#ai" className="text-gray-300 hover:text-white">AI Capabilities</a>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/admin/login" className="bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition-colors">
                Admin Login
              </Link>
            </div>
          </div>
      ...
      <main>
        ...
        {/* AI Features Grid */}
        <div id="ai" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
